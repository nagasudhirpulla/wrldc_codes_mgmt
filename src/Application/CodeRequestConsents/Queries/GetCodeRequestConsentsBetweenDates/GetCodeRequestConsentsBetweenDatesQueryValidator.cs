...
public class GetCodeRequestConsentsBetweenDatesQueryValidator : AbstractValidator<GetCodeRequestConsentsBetweenDatesQuery>
{
    public GetCodeRequestConsentsBetweenDatesQueryValidator()
    {
